...
struct HomeView: View {
    ...
    private let buttonSize: CGSize = CGSize(width: 200, height: 40)
                ...
                ScrollView {
                    VStack(spacing: 30) {
                        ...
                        VStack(spacing: 18) {
                            ...
                            HStack {
                                InputField(icon: "network", placeholder: "IP Address", text: $ipAddress)
                            ...
                            // Folder Name Input
                            InputField(icon: "folder", placeholder: "Folder Name", text: $folderName)
                        }
                        .opacity(isShowingInputs ? 1 : 0)
                        .offset(y: isShowingInputs ? 0 : 20)
