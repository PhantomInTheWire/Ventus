...
class Ui_MainWindow(object):
    ...
    def handle_connect(self):
        ...
        success = self.network_handlers.handle_connect(
            self.codeInput.toPlainText(),
            self.folderName.toPlainText()
        )
    ...
    def load_settings(self):
        ...
        settings = {
            'device_name': "Inspiron 5508",
            'folder_path': "Downloads/Ventus",
    ...
    def handle_connect(self):
        ...
        try:
            ...
            if success:
                self.handle_network_connect(True)
                self.update_connection_status(True, self.codeInput.toPlainText())
                self.change_page('home')
            ...
            self.show_error_message("Connection Error", f"An error occurred: {str(e)}")
